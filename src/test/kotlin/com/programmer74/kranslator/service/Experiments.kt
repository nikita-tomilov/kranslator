...
class Experiments {
    ...
    fun foo() {
        ...
        val translator = LibreTranslate("http://localhost:5000")
        ...
        val translatedPagesPNG = pagesPNG.map { page ->
            ...
            textBlocks.forEach {
                val translated = translator.translate(it.text, TranslatorLanguage.DE, TranslatorLanguage.EN_US)
    ...
    private fun getMaxFittingFontSize(g: Graphics, font: Font, string: String?, width: Int, height: Int): Int {
        var minSize = 0
        var maxSize = 288
